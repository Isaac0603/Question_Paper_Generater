...
const QuestionEntryPage = () => {
  ...
  useEffect(() => {
    ...
    const fetchUnitId = async () => {
        try {
            ...
            const response = await fetch("https://question-paper-generater.onrender.com/api/units");
  ...
  const handleSaveQuestion = async () => {
    ...
    try {
      ...
      const response = await fetch("https://question-paper-generater.onrender.com/api/questions-isaac", {
        method: "POST",
        headers: {
  ...
  const handleDeleteQuestion = async () => {
    ...
    try {
      ...
      if (questionId && token) {
        try {
          const response = await fetch(`https://question-paper-generater.onrender.com/api/questions-isaac/${questionId}`, {
            method: "DELETE",
            headers: {
              "Authorization": `Bearer ${token}`,
            },
